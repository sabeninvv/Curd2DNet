...
def createModel():
  vec_input = Input(shape=(150,150,2,))
  x = BatchNormalization()(vec_input)
  ...
  x = BatchNormalization()(x)
  #########################################
  x1 = BatchNormalization()(vec_input)
  x1 = Conv2D(16, (9,5), activation='relu', padding='same')(x1)
  x1 = Conv2D(16, (9,5), activation='relu', padding='same')(x1)
  x1 = MaxPooling2D()(x1)
  x1 = Dropout(0.3)(x1)
  x1 = BatchNormalization()(x1)
  x1 = Conv2D(32, (7,5), activation='relu', padding='same')(x1)
  x1 = Conv2D(32, (7,5), activation='relu', padding='same')(x1)
  x1 = MaxPooling2D()(x1)
  x1 = Dropout(0.3)(x1)
  x1 = BatchNormalization()(x1)
  x1 = Conv2D(64, (5,3), activation='relu', padding='same')(x1)
  x1 = Conv2D(64, (5,3), activation='relu', padding='same')(x1)
  x1 = MaxPooling2D()(x1)
  x1 = Dropout(0.3)(x1)
  x1 = BatchNormalization()(x1)
  x1 = Conv2D(128, (3,1), activation='relu', padding='same')(x1)
  x1 = Conv2D(128, (3,1), activation='relu', padding='same')(x1)
  x1 = MaxPooling2D()(x1)
  x1 = Dropout(0.3)(x1)
  x1 = BatchNormalization()(x1)
...
def getWeightsModel(model, pathWeights=None):
  try:
    if pathWeights:
...
def activationModule(path_to_dir_Curd2DNet = None):
  try: 
    import goToCurd
